...
public class MIActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void ToLengthOptions(){
        Intent intent = new Intent(MIActivity.this, LengthMI.class);
        startActivity(intent);
    }

    void ToVolumeOptions(){
        Intent intent = new Intent(MIActivity.this, VolumeMI.class);
        startActivity(intent);
    }

    void ToMassOptions(){
        Intent intent = new Intent(MIActivity.this, MassMI.class);
        startActivity(intent);
    }

    void ToTempOptions(){
        Intent intent = new Intent(MIActivity.this, TempMI.class);
        startActivity(intent);
    }
}
